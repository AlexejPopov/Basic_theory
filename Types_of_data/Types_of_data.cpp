...
int main()
{
    ...
    Логический тип данных bool обозначает правду либо ложь и занимает           1 байт  
    Следующий по старшенству char - одиночный символ, один значок   занимает    1 байт
    следующий short                                                 занимает    2 байта     диапазон: от -32,768 до 32,767
    следующий unsigned short (!) беззнаковая форма записи на ступеньку старше   2 байта     диапазон: от  0             до 65,535
    следующий int                                                   занимает    4 байта     диапазон: от −2,147,483,648 до 2,147,483,647 
    следующий unsigned int                                          занимает    4 байта     диапазон: от  0             до 4,294,967,295
    следующий long                                                  занимает    4 байта     диапазон: от −2,147,483,648 до 2,147,483,647
    следующий unsigned long                                         занимает    4 байта     диапазон: от  0             до 4,294,967,295
    следующий long int                                              занимает    8 байт      диапазон: от −9,223,372,036,854,775,808 до 9,223,372,036,854,775,807
    следующий unsigned long int                                     занимает    8 байт      диапазон: от  0             до 18,446,744,073,709,551,615
    следующий long long                                             занимает    8 байт      диапазон: от −9,223,372,036,854,775,808 до 9,223,372,036,854,775,807
    следующий unsigned long long                                    занимает    8 байт      диапазон: от  0             до 18,446,744,073,709,551,615
    следующий float                                                 занимает    4 байта     диапазон: от 3.4е^(-38) до 3.4e^(38)
    следующий double                                                занимает    8 байт      диапазон: от 1.7e^(-308) до 1.7e^(308)
    следующий long double в зависимости от платформы занимает 16 или 8 байт. В Visual Studio long double отображается также как и double.
    (!) У вещественных типов данных нет беззнаковости!
