...
Литералы - это указанные в тексте программы непосредственно значения. Эти значения не можем мы изменить, не можем их поменять, можем лишь поместить их куда-то либо вы-
вести на экран.
...
int main()
{
	...
	/* long long C - это мы создали объект/хранилище нужного объёма, выделили ячейку в ОЗУ, а 15LL - это мы хотим поместить туда содержимое нужного размера!
	...
	bool F = true;																		// у bool литерала всего 2 - правильного написания содержимиго - true/false
